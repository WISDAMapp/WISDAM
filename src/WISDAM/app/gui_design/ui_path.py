...
class Ui_popup_path(object):
    def setupUi(self, popup_path):
        if not popup_path.objectName():
            popup_path.setObjectName(u"popup_path")
        ...
        popup_path.setStyleSheet(u"QWidget {background: transparent; color: rgb(210, 210, 210)}\n"
"QToolTip {\n"
"	color: #ffffff;\n"
...
"}")
        ...
        self.treeView_paths.setObjectName(u"treeView_paths")
        self.treeView_paths.setGeometry(QRect(50, 60, 861, 461))
        self.treeView_paths.setStyleSheet(u"background-color: rgb(44, 49, 60);")
        self.treeView_paths.setEditTriggers(QAbstractItemView.DoubleClicked)
        self.treeView_paths.setProperty(u"showDropIndicator", False)
    ...
    def retranslateUi(self, popup_path):
        popup_path.setWindowTitle(QCoreApplication.translate("popup_path", u"MainWindow", None))
        self.lbl_icon.setText("")
#if QT_CONFIG(tooltip)
        self.label_title.setToolTip(QCoreApplication.translate("popup_path", u"<html><head/><body><p><span style=\" font-size:8pt; font-weight:400;\">Move window</span></p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.label_title.setText(QCoreApplication.translate("popup_path", u"PATH INSPECTOR", None))
#if QT_CONFIG(tooltip)
        self.btn_close.setToolTip(QCoreApplication.translate("popup_path", u"Close", None))
#endif // QT_CONFIG(tooltip)
        self.btn_close.setText("")
#if QT_CONFIG(tooltip)
        self.treeView_paths.setToolTip(QCoreApplication.translate("popup_path", u"<html><head/><body><p>Change Path by doubleclicking on folders.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.label_info.setText(QCoreApplication.translate("popup_path", u"Change Path by double click on image. Will be set for all images in that folder. Green indicates the image is found while red states missing image.", None))
    # retranslateUi
