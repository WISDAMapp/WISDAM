...
class Ui_popup_confirm(object):
    def setupUi(self, popup_confirm):
        if not popup_confirm.objectName():
            popup_confirm.setObjectName(u"popup_confirm")
        ...
        popup_confirm.setStyleSheet(u"QWidget {background: transparent; color: rgb(210, 210, 210)}\n"
"QToolTip {\n"
"	color: #ffffff;\n"
...
"}")
    ...
    def retranslateUi(self, popup_confirm):
        popup_confirm.setWindowTitle(QCoreApplication.translate("popup_confirm", u"MainWindow", None))
        self.lbl_icon.setText("")
#if QT_CONFIG(tooltip)
        self.label_title.setToolTip(QCoreApplication.translate("popup_confirm", u"<html><head/><body><p><span style=\" font-size:8pt; font-weight:400;\">Move window</span></p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.label_title.setText(QCoreApplication.translate("popup_confirm", u"CONFIRM", None))
        self.btn_ok.setText(QCoreApplication.translate("popup_confirm", u"Ok", None))
        self.btn_cancel.setText(QCoreApplication.translate("popup_confirm", u"Cancel", None))
