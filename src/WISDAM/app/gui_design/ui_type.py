...
################################################################################
## Form generated from reading UI file 'gui_type.ui'
##
...
class Ui_popup_type(object):
    def setupUi(self, popup_type):
        if not popup_type.objectName():
            popup_type.setObjectName(u"popup_type")
        popup_type.resize(250, 150)
        sizePolicy = QSizePolicy(QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(popup_type.sizePolicy().hasHeightForWidth())
        popup_type.setSizePolicy(sizePolicy)
        popup_type.setMinimumSize(QSize(250, 150))
        palette = QPalette()
...
#endif
        popup_type.setPalette(palette)
        font = QFont()
        font.setFamilies([u"Segoe UI"])
        font.setPointSize(10)
        popup_type.setFont(font)
        popup_type.setStyleSheet(u"QWidget {background: transparent; color: rgb(210, 210, 210)}\n"
"QToolTip {\n"
"	color: #ffffff;\n"
...
"\n"
"")
        popup_type.setLocale(QLocale(QLocale.English, QLocale.Austria))
        self.horizontalLayout = QHBoxLayout(popup_type)
        self.horizontalLayout.setSpacing(0)
        self.horizontalLayout.setObjectName(u"horizontalLayout")
        self.horizontalLayout.setContentsMargins(0, 0, 0, 0)
        self.frame_main = QFrame(popup_type)
...
"	border: 2px solid rgb(43, 50, 61);\n"
"}")
        self.input_object_name = QLineEdit(self.frame_center)
        self.input_object_name.setObjectName(u"input_object_name")
        self.input_object_name.setGeometry(QRect(10, 23, 231, 23))
        self.input_object_name.setFont(font3)
        self.input_object_name.setStyleSheet(u"background-color:black;\n"
"color:white")
        ...
        self.retranslateUi(popup_type)

        QMetaObject.connectSlotsByName(popup_type)
    # setupUi

    def retranslateUi(self, popup_type):
        popup_type.setWindowTitle(QCoreApplication.translate("popup_type", u"MainWindow", None))
        self.lbl_icon.setText("")
#if QT_CONFIG(tooltip)
        self.label_title.setToolTip(QCoreApplication.translate("popup_type", u"<html><head/><body><p><span style=\" font-size:8pt; font-weight:400;\">Move window</span></p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.label_title.setText(QCoreApplication.translate("popup_type", u"CHANGE TYPE", None))
        self.btn_ok.setText(QCoreApplication.translate("popup_type", u"Ok", None))
        self.btn_cancel.setText(QCoreApplication.translate("popup_type", u"Cancel", None))
        self.input_object_name.setText("")
    # retranslateUi
